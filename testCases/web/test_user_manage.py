from utils.myfunction.sqlMy.select import select_user_nick, select_id_nick
from utils.myfunction.myWeb.read_csv_web import read_rt_input_result_csv, read_rt_input_csv
from utils.myClass.myWeb.login_page import LoginPage
from utils.myClass.myWeb.user_manage_page import UserManager
...
@allure.story("登录功能")
@allure.title("{aid}")
@pytest.mark.parametrize('my_input,my_expect,aid',read_rt_input_result_csv('docs/web自动化测试用例.csv',left=0,right=7))
def test_login01(my_traces,login_page,my_input,my_expect,aid):
...
@allure.story("登录功能")
@allure.title("{aid}")
@pytest.mark.parametrize("my_input,aid",read_rt_input_csv('docs/web自动化测试用例.csv',8))
def test_login02(my_traces,login_page,my_input,aid):
    dict_input: Dict[str] = json.loads(my_input)
    my_login_page = LoginPage(login_page)
    my_login_page.login(dict_input.get("zh"), dict_input.get("pwd"), dict_input.get("flag"))
    with allure.step("断言"):
...
@allure.story("登录功能")
@allure.title("{aid}")
@pytest.mark.parametrize("my_input,aid",read_rt_input_csv('docs/web自动化测试用例.csv',10))
def test_login04(my_traces,login_page,my_input,aid):
    dict_input: Dict[str] = json.loads(my_input)
    my_login_page = LoginPage(login_page)
    my_login_page.login(dict_input.get("zh"), dict_input.get("pwd"), dict_input.get("flag"))
    my_login_page.login_click()
...
@allure.story("登录功能")
@allure.title("{aid}")
@pytest.mark.parametrize("my_input,aid",read_rt_input_csv('docs/web自动化测试用例.csv',11))
def test_login05(new_chrome,chrome_context,login_page,my_input,aid):
    dict_input: Dict[str] = json.loads(my_input)
    my_login_page = LoginPage(login_page)
    my_login_page.login(dict_input.get("zh"), dict_input.get("pwd"), dict_input.get("flag"))
    my_login_page.login_click()
    ...
    UserManager(login_page).get_simple_assert("若依后台管理框架")
    chrome_context.storage_state(path='testCases/web/cache/auth.json')
...
@allure.story("登录功能")
@allure.title("{aid}")
@pytest.mark.parametrize('my_input,my_expect,aid',read_rt_input_result_csv('docs/web自动化测试用例.csv',12))
def test_login06(my_traces,login_page,my_input,my_expect,aid):
    dict_input:Dict[str]=json.loads(my_input)
    my_login_page=LoginPage(login_page)
...
@allure.story("登录功能")
@allure.title("{aid}")
@pytest.mark.parametrize('my_input,aid',read_rt_input_csv('docs/web自动化测试用例.csv',13))
def test_login07(my_traces,login_page,my_input,aid):
    dict_input:Dict[str]=json.loads(my_input)
    my_login_page=LoginPage(login_page)
    my_login_page.login(dict_input.get("zh"),dict_input.get("pwd"),dict_input.get("flag"))
    my_login_page.login_click()
...
@allure.story("登录功能")
@allure.title("{aid}")
@pytest.mark.parametrize('my_input,aid',read_rt_input_csv('docs/web自动化测试用例.csv',14))
def test_login08(my_traces,login_page,my_input,aid):
    dict_input:Dict[str]=json.loads(my_input)
    my_login_page=LoginPage(login_page)
    my_login_page.login(dict_input.get("zh"),dict_input.get("pwd"),dict_input.get("flag"))
    my_login_page.login_click()
...
@allure.story("登录功能")
@allure.title("{aid}")
@pytest.mark.parametrize("my_input,aid",read_rt_input_csv('docs/web自动化测试用例.csv',15,16))
def test_login09(my_traces,login_page,my_input,aid):
    dict_input: Dict[str] = json.loads(my_input)
    my_login_page = LoginPage(login_page)
    my_login_page.back()
...
@allure.story("登录功能")
@allure.title("{aid}")
@pytest.mark.parametrize("my_input,aid",read_rt_input_csv('docs/web自动化测试用例.csv',17))
def test_login10(chrome_context,my_traces,login_page,my_input,aid):
    dict_input: Dict[str] = json.loads(my_input)
    my_login_page = LoginPage(login_page)
    my_login_page.login(dict_input.get("zh"), dict_input.get("pwd"), dict_input.get("flag"))
    my_login_page.login_click()
...
@allure.story("新增功能")
@allure.title("{aid}")
@pytest.mark.parametrize("my_input,aid",read_rt_input_csv('docs/web自动化测试用例.csv',18,19,25))
def test_manage01(my_traces,user_manage_page,select_a_man,my_input,aid):
...
@allure.story("新增功能")
@allure.title("{aid}")
@pytest.mark.parametrize("my_input,aid",read_rt_input_csv('docs/web自动化测试用例.csv',20))
def test_manage02(my_traces,user_manage_page,select_a_man,my_input,aid):
    my_cursor = select_a_man
    dict_input: Dict[str] = json.loads(my_input)
    my_manage_page = UserManager(user_manage_page)
    my_add = my_manage_page.click_adduser()
...
@allure.story("新增功能")
@allure.title("{aid}")
@pytest.mark.parametrize("my_input,aid",read_rt_input_csv('docs/web自动化测试用例.csv',21))
def test_manage03(my_traces,user_manage_page,select_a_man,my_input,aid):
    my_cursor = select_a_man
    dict_input: Dict[str] = json.loads(my_input)
    my_manage_page = UserManager(user_manage_page)
    my_add = my_manage_page.click_adduser()
...
@allure.story("新增功能")
@allure.title("{aid}")
@pytest.mark.parametrize("my_input,aid",read_rt_input_csv('docs/web自动化测试用例.csv',22))
def test_manage04(my_traces,user_manage_page,my_input,aid):
    dict_input: Dict[str] = json.loads(my_input)
    my_manage_page = UserManager(user_manage_page)
    my_add = my_manage_page.click_adduser()
...
@allure.story("新增功能")
@allure.title("{aid}")
@pytest.mark.parametrize("my_input,msg,aid",read_rt_input_result_csv('docs/web自动化测试用例.csv',23,24))
def test_manage05(my_traces,user_manage_page,select_a_man,my_input,msg,aid):
    dict_input: Dict[str] = json.loads(my_input)
    my_manage_page = UserManager(user_manage_page)
    my_add = my_manage_page.click_adduser()
    my_add.fill_base_info(dict_input.get("nickname"), dict_input.get("zh"), dict_input.get("pwd"))
...
@allure.story("新增功能")
@allure.title("{aid}")
@pytest.mark.parametrize("my_input,aid",read_rt_input_csv('docs/web自动化测试用例.csv',26))
def test_manage06(my_traces,user_manage_page,select_a_man,my_input,aid):
    my_cursor = select_a_man
    dict_input: Dict[str] = json.loads(my_input)
    my_manage_page = UserManager(user_manage_page)
    my_add = my_manage_page.click_adduser()
...
@allure.story("新增功能")
@allure.title("{aid}")
@pytest.mark.parametrize("my_input,aid",read_rt_input_csv('docs/web自动化测试用例.csv',27))
def test_manage07(my_traces,user_manage_page,my_input,select_a_man,aid):
    dict_input: Dict[str] = json.loads(my_input)
    my_manage_page = UserManager(user_manage_page)
    my_add = my_manage_page.click_adduser()
    my_add.fill_base_info(dict_input.get("nickname"), dict_input.get("zh"), dict_input.get("pwd"))
...
@allure.story("新增功能")
@allure.title("{aid}")
@pytest.mark.parametrize("my_input,aid",read_rt_input_csv('docs/web自动化测试用例.csv',28))
def test_manage08(my_traces,user_manage_page,my_input,select_a_man,aid):
    my_cursor = select_a_man
    dict_input: Dict[str] = json.loads(my_input)
    my_manage_page = UserManager(user_manage_page)
    my_add = my_manage_page.click_adduser()
...
@allure.story("修改功能")
@allure.title("{aid}")
@pytest.mark.parametrize("my_input,aid",read_rt_input_csv('docs/web自动化测试用例.csv',29))
def test_alter01(my_traces,user_manage_page,my_input,make_a_man,aid):
...
@allure.story("修改功能")
@allure.title("{aid}")
@pytest.mark.parametrize("my_input,aid",read_rt_input_csv('docs/web自动化测试用例.csv',30))
def test_alter02(my_traces,user_manage_page,my_input,make_a_man,aid):
    my_cursor ,uid= make_a_man
    dict_input: Dict[str] = json.loads(my_input)
    my_manage_page = UserManager(user_manage_page)
    my_manage_page.select_user(f"{uid}")
...
@allure.story("修改功能")
@allure.title("{aid}")
@pytest.mark.parametrize("my_input,aid",read_rt_input_csv('docs/web自动化测试用例.csv',31))
def test_alter03(my_traces,user_manage_page,my_input,select_a_man,aid):
    dict_input: Dict[str] = json.loads(my_input)
    my_manage_page = UserManager(user_manage_page)
    my_add = my_manage_page.click_adduser()
    my_add.fill_base_info(dict_input.get("nickname"), dict_input.get("zh"), dict_input.get("pwd"))
...
@allure.story("修改功能")
@allure.title("{aid}")
@pytest.mark.parametrize("my_input,aid",read_rt_input_csv('docs/web自动化测试用例.csv',32))
def test_alter04(my_traces,user_manage_page,my_input,make_a_man,aid):
    my_cursor ,uid= make_a_man
    dict_input: Dict[str] = json.loads(my_input)
    my_manage_page = UserManager(user_manage_page)
    my_manage_page.select_user(f"{uid}")
...
@allure.story("修改功能")
@allure.title("{aid}")
@pytest.mark.parametrize("my_input,aid",read_rt_input_csv('docs/web自动化测试用例.csv',33))
def test_alter05(my_traces,user_manage_page,my_input,make_a_man,aid):
    my_cursor ,uid= make_a_man
    dict_input: Dict[str] = json.loads(my_input)
    my_manage_page = UserManager(user_manage_page)
    my_manage_page.select_user(f"{uid}")
...
@allure.story("删除功能")
@allure.title("{aid}")
@pytest.mark.parametrize("my_input,aid",read_rt_input_csv('docs/web自动化测试用例.csv',34,36))
def test_del01(my_traces,user_manage_page,my_input,make_a_man,aid):
    my_cursor ,uid= make_a_man
    dict_input: Dict[str] = json.loads(my_input)
    my_manage_page = UserManager(user_manage_page)
    my_manage_page.select_user(f"{uid}")
...
@allure.story("删除功能")
@allure.title("{aid}")
@pytest.mark.parametrize("my_input,aid",read_rt_input_csv('docs/web自动化测试用例.csv',35))
def test_del02(my_traces,user_manage_page,my_input,make_a_man,aid):
    my_cursor ,uid= make_a_man
    dict_input: Dict[str] = json.loads(my_input)
    my_manage_page = UserManager(user_manage_page)
    my_manage_page.select_user(f"{uid}")
...
@allure.story("删除功能")
@allure.title("{aid}")
@pytest.mark.parametrize("my_input,aid",read_rt_input_csv('docs/web自动化测试用例.csv',37))
def test_del03(my_traces,user_manage_page,my_input,aid):
    my_manage_page = UserManager(user_manage_page)
